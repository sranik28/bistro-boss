...
const Register = () => {
    const { createUser, googleUser } = useAuthGolobally()
    ...
    return (
        <main>
            ...
            <section className='max-w-[1240px] mx-auto  relative z-50 h-screen  md:flex items-center'>
                <div style={{ boxShadow: "10px 10px 10px 10px rgba(0, 0, 0, 0.25)" }} className='flex p-14 '>
                    ...
                    <form onSubmit={handleForm}>
                        <div className='mt-5'>
                            ...
                            <input className='px-7 py-4 bg-white rounded-md outline-0' name="name" type="text" placeholder='Type here' />
                        </div>
                        <div className='mt-5'>
                            <label className='font-bold block'>Email</label>
                            <input className='px-7 py-4 bg-white rounded-md outline-0' name="email" type="email" placeholder='Enter your email' />
                        </div>
                        <div className='mt-5'>
                            <label className='font-bold block'>Password</label>
                            <input className='px-7 py-4 bg-white rounded-md outline-0' name="password" type="password" placeholder='Enter your password' />
                        </div>
                        <p className='text-red-700 mt-2'>{error && error}</p>
                        <p className="text-green-500 mt-2">{success && success}</p>
                        <div className='mt-5'>
